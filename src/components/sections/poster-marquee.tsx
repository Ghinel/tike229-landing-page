  ...
  return (
    <div className="flex gap-4" aria-hidden={duplicate || undefined}>
      {marquee.posters.map((poster, i) => (
        <div
          key={i}
          className="relative h-[210px] w-[150px] shrink-0 overflow-hidden border-2 border-solid border-bone/30"
        >
...
export function PosterMarquee() {
  return (
    <section className="relative overflow-hidden border-t-2 border-solid border-bone/15 bg-ink py-10">
